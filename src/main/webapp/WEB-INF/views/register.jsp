			...
			<div
									...
									<form class="mx-1 mx-md-4">
										...
										<div class="d-flex flex-row align-items-center mb-4">
											...
											<div class="form-outline flex-fill mb-0">
												...
												<label class="form-label" for="userName">Unique User
													Name</label>
											</div>
										</div>
				...
				<div class="d-flex flex-row align-items-center mb-4">
										...
										<div class="d-flex flex-row align-items-center mb-4">
											<i class="fas fa-user fa-lg me-3 fa-fw"></i>
											<div class="form-outline flex-fill mb-0">
												<input type="text" id="customerAddr" name="customerAddr" class="form-control" required/>
												<label class="form-label" for="customerAddr">User
													Address</label>
											</div>
										</div>
										...
										<div class="d-flex flex-row align-items-center mb-4">
											...
											<div class="form-outline flex-fill mb-0">
												<input type="repeatPassword" id="repeatPassword" name="repeatPassword"
													class="form-control" required/> <label class="form-label"
													for="repeatPassword">Repeat your password</label>
											</div>
										</div>
										...
										<div class="form-check d-flex justify-content-center mb-5">
											<input class="form-check-input me-2" type="checkbox" value=""
												...
												for="form2Example3" required> I agree all statements in <a
